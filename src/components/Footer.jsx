    ...
    return (
        <div className="py-5 border-t-3/2">
            <div className="flex justify-center mt-4">
                <a href="https://github.com/gouthamvishnu" className="text-xl m-1 p-1 sm:p-2 text-gray-800 hover:bg-gray-800 rounded-full hover:text-white transition-colors duration-300">
                    <FaGithub />
                    <span className="sr-only">Github</span>
                </a>
                <a href="https://instagram.com/ninja_idk__" className="text-xl m-1 p-1 sm:p-2 text-pink-800 hover:bg-pink-800 rounded-full hover:text-white transition-colors duration-300">
                    <FaInstagram />
